...
/*************  ✨ Codeium Command ⭐  *************/
/**
 * Renders a detailed page showcasing the Audi A3 car with various specifications
 * and booking options.
 * 
 * The page includes an image of the car, detailed specifications such as passenger
 * capacity, luggage capacity, transmission type, and number of doors. It also provides
 * sections about refueling, car wash, and no smoking policies with descriptive
 * text.
 * 
 * Additional features are listed under "Included" and "Not Included" sections using
 * icons to indicate availability.
 * 
 * The page also contains a form for users to input their personal details and pickup
 * information, including full name, email, phone number, pickup address, date, and time.
 * 
 * A button is provided for users to confirm their selection and proceed.
 */

/******  31ae4290-5850-4e66-b2b5-1be946e9e13a  *******/
function Page() {
    return (
        <div  >
            {/* <div className="mx-40 border border-red-500">hello</div> */}
            <div className="relative">
                <Image src='/carImages/tampo-traveler.jpg' height={1000} width={1000} alt='audi' className='object-cover origin-center w-full h-[600px]' />
                <div className="ml-40 mt-10  ">
                    <div className="w-3/5 ">
                        <h2 className='text-4xl font-semibold' >Tampo Traveler</h2>
