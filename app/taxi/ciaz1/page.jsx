    ...
    return (
        <div  >
            ...
            <div className="relative">
                <Image src='/carImages/ciaz.jpg' height={1000} width={1000} alt='audi' className='object-cover origin-center w-full h-[600px]' />
                <div className="ml-40 mt-10  ">
                    <div className="w-3/5 ">
                        <h2 className='text-4xl font-semibold' >Ciaz</h2>
